...
<SCRIPT type="text/javascript" language="JavaScript" >
    function timeZoneChange() {
        document.chgtimedate.nextstage.value = 0;
        document.chgtimedate.timezonechange.value = 1;
        document.chgtimedate.submit();
        
        return false;
    }
</SCRIPT>
<form action="/auth/chgdatetime.pl" name="chgtimedate" method="post">
...
<br />
<br />
<input type="submit" tabindex="1" value="[% lang.m01028 %]" >
...
<input type="hidden" name="timezonechange" >
</form>
