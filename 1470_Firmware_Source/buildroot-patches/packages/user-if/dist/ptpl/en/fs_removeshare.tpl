...
<br />
<p>[% lang.m13004 %]<input type="text" name="confirm" id="confirm" tabindex="1" size="3" maxlength="3" value="[% frm.confirm %]"></p>
<input type="submit" name="submit" tabindex="2" value="[% lang.m13007 %]" >
