...
#define CONFIG_COMMANDS OTP_COMMANDS
...
extern unsigned spi_820_read(void);
#endif 
/* not required debounce input? (*(u32 *)GPIO_1_DBC) &= ~(1<<I2C_MISO);\ */
...
#define SPI_DELAY       do { volatile int i; for (i=0; i < 10; i++) ; asm volatile ("" : : : "memory");\
